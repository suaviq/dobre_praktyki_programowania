...
class TestLinksEndpoints:
    ...
    def test_get_links_returns_all_items(self, client, sample_links):
    ...
    def test_get_links_empty_database(self, client):
    ...
    def test_get_link_by_movie_id_success(self, client, single_link):
        """Test GET /links/{movie_id} - zwraca link dla danego movie_id"""
        response = client.get(f"/links/{single_link.movieId}")
    ...
    def test_create_link_success(self, client, db_session):
        ...
        verify_response = client.get("/links/999")
        assert verify_response.status_code == 200

    def test_create_link_duplicate_movie_id(self, client, single_link):
    ...
    def test_update_link_success(self, client, single_link):
        ...
        response = client.put(f"/links/{single_link.movieId}", json=update_data)
        ...
        verify_response = client.get(f"/links/{single_link.movieId}")
    ...
    def test_update_link_not_found(self, client):
        ...
        response = client.put("/links/99999", json=update_data)
        
        assert response.status_code == 404

    # ==================== DELETE ====================

    def test_delete_link_success(self, client, single_link):
        """Test DELETE /links/{movie_id} - usuwa link"""
        response = client.delete(f"/links/{single_link.movieId}")
